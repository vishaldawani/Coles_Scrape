...
class Coles_Spider_URL:
	def __init__(self,url_folder,url_file,output_name,range_start,range_end):

		temp_df=pd.read_csv(URL_FOLDER+"\\"+URL_FILE)
		self.df=temp_df.iloc[range_start:range_end]
